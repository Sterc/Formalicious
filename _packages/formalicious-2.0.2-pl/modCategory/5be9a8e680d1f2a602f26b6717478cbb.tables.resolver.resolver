...
if ($object->xpdo) {
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        case xPDOTransport::ACTION_INSTALL:
            $modx =& $object->xpdo;
            $modx->addPackage('formalicious', $modx->getOption('formalicious.core_path', null, $modx->getOption('core_path') . 'components/formalicious/') . 'model/');
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            alterTable($modx, 'FormaliciousCategory');
            alterTable($modx, 'FormaliciousForm');
            alterTable($modx, 'FormaliciousStep');
            alterTable($modx, 'FormaliciousFieldType');
            alterTable($modx, 'FormaliciousField');
            alterTable($modx, 'FormaliciousAnswer');
