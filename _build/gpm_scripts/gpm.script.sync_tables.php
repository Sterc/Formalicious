...
if ($transport->xpdo) {
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        case xPDOTransport::ACTION_UPGRADE:
            ...
            $tables = [
                \Sterc\Formalicious\Model\FormaliciousAnswer::class,
                \Sterc\Formalicious\Model\FormaliciousCategory::class,
                \Sterc\Formalicious\Model\FormaliciousField::class,
                \Sterc\Formalicious\Model\FormaliciousFieldType::class,
                \Sterc\Formalicious\Model\FormaliciousForm::class,
                \Sterc\Formalicious\Model\FormaliciousStep::class,
            ];
